...
(async () => {
  ...
  console.log('timbrado contrato tamanho:', timbB64 ? timbB64.length : 'NULL');
  ...
  fs.writeFileSync('/var/www/liga-urologia/public/teste_timb4.pdf', pdf);
  await browser.close();
  console.log('PDF gerado! Acesse: /teste_timb4.pdf');
