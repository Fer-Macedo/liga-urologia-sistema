...
function htmlCobranca(opts) {
  ...
  const scartao=linkCartao
    ?'<div style="margin:0 0 16px;border-radius:12px;overflow:hidden;border:1.5px solid #bfdbfe">'
     +'<div style="background:#1e3a8a;padding:12px 20px">'
     +'<span style="color:white;font-weight:700;font-size:13px;letter-spacing:0.5px;text-transform:uppercase">Pagamento com Cartao de Credito</span>'
     +'</div>'
     +'<div style="background:#eff6ff;padding:20px;text-align:center">'
     +'<p style="margin:0 0 16px;font-size:12px;color:#374151;line-height:1.6">Clique no botao abaixo para ser redirecionado ao ambiente seguro de pagamento:</p>'
     +'<a href="'+linkCartao+'" style="display:inline-block;background:'+orgCor+';color:white;padding:13px 40px;border-radius:6px;text-decoration:none;font-weight:700;font-size:13px;letter-spacing:0.5px;text-transform:uppercase">Pagar com Cartao</a>'
     +'<p style="margin:12px 0 0;font-size:10px;color:#94a3b8;letter-spacing:0.3px">Ambiente seguro — processado pelo PagBank</p>'
     +'</div></div>'
    :'';
