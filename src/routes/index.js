...
router.get('/contratos/:id/visualizar', requireAuth, async (req, res) => {
  try {
    ...
    const css='*{margin:0;padding:0;box-sizing:border-box;}body{font-family:Times New Roman,serif;font-size:11pt;}.pg{width:210mm;min-height:297mm;position:relative;overflow:hidden;}.timb{position:absolute;top:0;left:0;width:210mm;height:297mm;object-fit:fill;z-index:0;display:block;}.tx{position:relative;z-index:1;padding:52mm 22mm 35mm 22mm;}.tit{text-align:center;font-weight:bold;font-size:12pt;margin-bottom:14px;text-transform:uppercase;}.co{line-height:1.6;font-size:10.5pt;}.co *{line-height:1.6;}.co p{margin-bottom:6px;}.co .ql-align-center,.co [style*="text-align: center"],[style*="text-align:center"]{text-align:center!important;}.co .ql-align-right,.co [style*="text-align: right"]{text-align:right!important;}.co .ql-align-justify,.co [style*="text-align: justify"]{text-align:justify!important;}.ass{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:20px;page-break-inside:avoid;}.ab{text-align:center;}.ai{max-height:44px;max-width:120px;object-fit:contain;margin-bottom:3px;}.ae{height:44px;}.al{border-top:1.5px solid #000;width:85%;margin:0 auto 3px;}.an{font-size:9.5pt;font-weight:bold;text-transform:uppercase;}.ac{font-size:9pt;}';
    ...
    const body=`<div class='pg'>${timb}<div class='tx'><div class='tit'>CONTRATO DE LIGA ACADEMICA Y MIEMBRO ACTIVO<br>LIGA ACADEMICA DE UROLOGIA - LAURO</div>${dadosLigante}<div class='co'>${texto}</div><div class='ass'><div class='ab'><div class='ae'></div><div class='al'></div><div class='an'>${(d.nome||'').toUpperCase()}</div><div class='ac'>Miembro Activo</div></div>${aImg(assPresB64,nomeP,'Presidente')}${aImg(assViceB64,nomeV,'Vice-Presidente')}${aImg(assSecB64,nomeS,'Secretario')}${aImg(assOriB64,nomeO,'Docente Orientador')}</div></div></div>`;
