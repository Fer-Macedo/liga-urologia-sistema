...
router.get('/contratos/:id/visualizar', requireAuth, async (req, res) => {
  try {
    ...
    const css='*{margin:0;padding:0;box-sizing:border-box;}body{font-family:Times New Roman,serif;font-size:11pt;}.pg{width:210mm;min-height:297mm;position:relative;overflow:hidden;}.timb{position:absolute;top:0;left:0;width:210mm;height:297mm;object-fit:fill;z-index:0;display:block;}.tx{position:relative;z-index:1;padding:52mm 22mm 35mm 22mm;}.tit{text-align:center;font-weight:bold;font-size:12pt;margin-bottom:14px;text-transform:uppercase;}.co{line-height:1.6;font-size:10.5pt;}.co p{margin-bottom:6px;}.co .ql-align-center{text-align:center!important;}.co .ql-align-right{text-align:right!important;}.co .ql-align-justify{text-align:justify!important;}.co .ql-align-left{text-align:left!important;}.co [style]{}.ass{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:20px;page-break-inside:avoid;}.ab{text-align:center;}.ai{max-height:44px;max-width:120px;object-fit:contain;margin-bottom:3px;}.ae{height:44px;}.al{border-top:1.5px solid #000;width:85%;margin:0 auto 3px;}.an{font-size:9.5pt;font-weight:bold;text-transform:uppercase;}.ac{font-size:9pt;}';
